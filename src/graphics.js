...
export function loadGraphics() {
    ...
    monsterSprites["minotaur"] = window.loadImage("assets/demons/RancorousBull.png");
    ...
    monsterSprites["antlered rascal"] = window.loadImage("assets/demons/AntleredRascal.png");
    monsterSprites["clawed abomination"] = window.loadImage("assets/demons/ClawedAbomination.png");
    monsterSprites["crimson imp"] = window.loadImage("assets/demons/CrimsonImp.png");
    monsterSprites["Depraved Blackguard"] = window.loadImage("assets/demons/DepravedBlackguard.png");
    monsterSprites["fledgling demon"] = window.loadImage("assets/demons/FledglingDemon.png");
    monsterSprites["floating eye"] = window.loadImage("assets/demons/FloatingEye.png");
    monsterSprites["foul gouger"] = window.loadImage("assets/demons/FoulGouger.png");
    monsterSprites["grinning gremlin"] = window.loadImage("assets/demons/GrinningGremlin.png");
    monsterSprites["nefarious scamp"] = window.loadImage("assets/demons/NefariousScamp.png");
    monsterSprites["pit balor"] = window.loadImage("assets/demons/PitBalor.png");
    monsterSprites["pointed demonspawn"] = window.loadImage("assets/demons/PointedDemonspawn.png");
    monsterSprites["Rascally Demonling"] = window.loadImage("assets/demons/RascallyDemonling.png");
    monsterSprites["skewering stalker"] = window.loadImage("assets/demons/SkeweringStalker.png");
    monsterSprites["tainted scoundrel"] = window.loadImage("assets/demons/TaintedScoundrel.png");
    monsterSprites["warp skull"] = window.loadImage("assets/demons/WarpSkull.png");

    monsterSprites["armored goliath"] = window.loadImage("assets/demons/ArmoredGoliath.png");
    monsterSprites["beastly impaler"] = window.loadImage("assets/demons/BeastlyImpalerIdleSide.png");
    monsterSprites["blade hellion"] = window.loadImage("assets/demons/BladeHellion.png");
    monsterSprites["Blood Drinker"] = window.loadImage("assets/demons/BloodDrinker.png");
    monsterSprites["bulging incubus"] = window.loadImage("assets/demons/BulgingIncubus.png");
    monsterSprites["dastardly Crusher"] = window.loadImage("assets/demons/DastardlyCrusher.png");
    monsterSprites["deadly cambion"] = window.loadImage("assets/demons/DeadlyCambion.png");
    monsterSprites["demonic arachnid"] = window.loadImage("assets/demons/DemonicArachnid.png");
    monsterSprites["ebon astaroth"] = window.loadImage("assets/demons/EbonAstaroth.png");
    monsterSprites["horned brute"] = window.loadImage("assets/demons/HornedBrute.png");
    monsterSprites["pronged fury"] = window.loadImage("assets/demons/ProngedFury.png");
    monsterSprites["red devil"] = window.loadImage("assets/demons/RedDevil.png");
    monsterSprites["spiked ravager"] = window.loadImage("assets/demons/SpikedRavager.png");
    monsterSprites["vicious miscreant"] = window.loadImage("assets/demons/ViciousMiscreant.png");
    monsterSprites["wicked wretch"] = window.loadImage("assets/demons/WickedWretch.png");

    monsterSprites["abyssal baron"] = window.loadImage("assets/demons/AbyssalBaron.png");
    monsterSprites["combusting balrog"] = window.loadImage("assets/demons/CombustingBalrog.png");
    monsterSprites["evil titan"] = window.loadImage("assets/demons/EvilTitan.png");
    monsterSprites["gigantic juggernaut"] = window.loadImage("assets/demons/GiganticJuggernaut.png");
    monsterSprites["infernal scorcher"] = window.loadImage("assets/demons/InfernalScorche.png");
    monsterSprites["leering leviathan"] = window.loadImage("assets/demons/LeeringLevithan.png");
    monsterSprites["Maleficent Ape"] = window.loadImage("assets/demons/MaleficentApe.png");
    monsterSprites["Mighty Desolator"] = window.loadImage("assets/demons/MightyDesolator.png");
    monsterSprites["rabid cerberus"] = window.loadImage("assets/demons/RabidCerberus.png");
    monsterSprites["Rancorous Bull"] = window.loadImage("assets/demons/RancorousBull.png");
    monsterSprites["Sanguine Annihilator"] = window.loadImage("assets/demons/SanguineAnnihilator.png");
    monsterSprites["Towering Mongrel"] = window.loadImage("assets/demons/ToweringMongrel.png");
    monsterSprites["vile tyrant"] = window.loadImage("assets/demons/VileTyrant.png");
    monsterSprites["warp lord"] = window.loadImage("assets/demons/WarpLord.png");
